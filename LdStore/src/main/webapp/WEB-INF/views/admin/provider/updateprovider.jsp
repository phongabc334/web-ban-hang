                ...
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    ...
                    <div class="d-flex">
                      ...
                      <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Quản lý danh mục&nbsp;&nbsp;/&nbsp;Cập nhật danh mục</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-12 grid-margin">
            <div class="card">
              <div class="card-body">
                ...
                <c:if test="${ not empty statusEditProviser }">
                	<c:if test="${ statusEditProviser == 'ok' }">
                ...
                <form:form action="${ editprovider.id }" modelAttribute="editprovider" method="POST">  
                  <p class="card-description">
                    Nhập mới thông tin hãng sản xuất
                  </p>
                  <div class="row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                        <form:input class="form-control" path="id" type="hidden" required="required" value="${ editprovider.id }"/>
                        <form:input class="form-control" path="name" placeholder="Mời nhập tên hãng" required="required" value="${ editprovider.name }"/>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <form:input class="form-control" path="description" placeholder="Mời nhập mô tả" required="required" value="${ editprovider.description }"/>
                        </div>
                      </div>
                    </div>
                  </div>
