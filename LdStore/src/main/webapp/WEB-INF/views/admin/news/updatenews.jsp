                  ...
                  <div class="mr-md-3 mr-xl-5">
                   <h2>Xin chào, ${ InfoAdmin.username }</h2>
                    <div class="d-flex">
                      ...
                      <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Quản lý sản phẩm&nbsp;&nbsp;/&nbsp;Cập nhật tin tức</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-12 grid-margin">
            <div class="card">
              <div class="card-body">
                ...
                <c:if test="${ not empty AdminEditNewsStatus }">
                	<c:if test="${ AdminEditNewsStatus == 'ok' }">
                ...
                <form:form action="${ AdminEditNews.id_news }" modelAttribute="AdminEditNews" method="POST" enctype="multipart/form-data">  
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                        	<img id="output" class="img-rounded" alt="Ảnh" width="200px" src='<c:url value="/template/user/images/${ AdminEditNews.img }" />' />
                    ...
                    <div class="col-md-12">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        	...
                        	<form:input class="form-control" path="id_news" value="${ AdminEditNews.id_news }" type="hidden"/>
