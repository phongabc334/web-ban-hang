                ...
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    ...
                    <div class="d-flex">
                      ...
                      <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Quản lý sản phẩm&nbsp;&nbsp;/&nbsp;Cập nhật sản phẩm</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-12 grid-margin">
            <div class="card">
              <div class="card-body">
                ...
                <c:if test="${ not empty AdminEditProductStatus }">
                	<c:if test="${ AdminEditProductStatus == 'ok' }">
                ...
                <form:form action="${ AdminEditProudct.id_product }" modelAttribute="AdminEditProudct" method="POST" enctype="multipart/form-data">  
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                        	<img id="output" class="img-rounded" alt="Ảnh" width="200px" src='<c:url value="/template/user/images/${ AdminEditProudct.img }" />' />
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                        	<form:input class="form-control" path="update_by" value="${ InfoAdmin.username }" type="hidden" />
                        	<form:input class="form-control" path="id_product" value="${ AdminEditProudct.id_product }" type="hidden" />
